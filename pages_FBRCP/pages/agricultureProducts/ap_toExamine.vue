<template>
	<view>
		...
		<view>
			<view class="buttonClass" v-if="headCurrent==0">
				<text class="btnClass" style="left: 3.5%;background: #007AFF;margin-left: 30upx;margin-right: 34upx;" @click="underReview(groupTitle[selectIndex],0)">审核通过</text>
				<text class="btnClass" style="left: 51.5%;background: #FA3534;" @click="underReview(groupTitle[selectIndex],1)">审核失败</text>
			</view>
		</view>
