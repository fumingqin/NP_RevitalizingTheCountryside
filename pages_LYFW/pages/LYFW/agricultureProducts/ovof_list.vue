		...
		<view>
			<view style="margin-top: 30upx;padding-left: 32upx;">
				<scroll-view class="to_scroll" scroll-x="true">
					<u-button type="success" :ripple="true" shape="square" ripple-bg-color="#909399" size="medium" :custom-style="customStyle">上架/下架</u-button>
				...
				<view class="groupTour" :class="{'select':selectIndex == index}" @tap="selectClick(index)" v-for="(item,index) in groupTitle" :key="index" v-if="index < scenicListIndex">
					...
					<view class="groupText">
						...
						<view class="groupCost">
							...
							<text class="sellComment" style="color: #42e800;" v-if="item.colleagueStatus=='enable'">上架中</text>
							<text class="sellComment" style="color: #ff0000;" v-if="item.colleagueStatus=='disable'">已下架</text>
						</view>
					</view>
				</view>
