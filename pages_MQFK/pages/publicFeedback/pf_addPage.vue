	...
	<view>
		<view class="content">
			<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
				...
				<u-form-item :label-style="customStyle" :label-position="labelPosition" label="反馈内容" :border-bottom="false" prop="intro">
					<view class="viewClass" style="padding:20rpx 30rpx;">
						<u-input type="textarea" :border="border" :height="height" placeholder="请填写反馈内容" v-model="model.intro" />
					</view>
				</u-form-item>
...
<script>
	...
	import robbyImageUpload from '@/pages_MQFK/components/robby-image-upload/robby-image-upload.vue';
	var _self;
	export default {
		components: {
				...
				this.$refs.uForm.validate(valid => {
					if (valid) {
						...
						if (this.issueText !== '<p><br></p>') {
							uni.request({
								url: this.$mqfk.KyInterface.releasefeedback.Url,
								method: this.$mqfk.KyInterface.releasefeedback.method,
								data: {
